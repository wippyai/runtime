...
func TestValuesEqualNumericEdgeCases(t *testing.T) {
	tests := []struct {
		...
		{0, 0.0, "zero int and zero float", true},
		{-5, -5.0, "negative equal", true},
		{int64(1000000), 1000000.0, "large numbers equal", true},
		{5, -5.0, "different signs", false},
	}
...
func TestToFloat64Boundaries(t *testing.T) {
	tests := []struct {
		...
		{int8(127), "max int8", 127.0},
		{int8(-128), "min int8", -128.0},
		{uint8(255), "max uint8", 255.0},
		{0, "zero", 0.0},
		{-42, "negative", -42.0},
	}
