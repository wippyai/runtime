...
func newRegistryError(l *lua.LState, kind apierr.Kind, retryable *bool, msg string, details attrs.Bag) lua.LValue {
...
func newRegistryOperationError(l *lua.LState, err error, operation string) lua.LValue {
	...
	retryable := false
	return newRegistryError(l, apierr.KindInternal, &retryable, err.Error(), details)
}
