...
func TestYieldCmdID(t *testing.T) {
	tests := []struct {
		...
		{"Send", func() interface{ CmdID() dispatcher.CommandID } { return AcquireSendYield() }, process.Send},
		{"Spawn", func() interface{ CmdID() dispatcher.CommandID } { return AcquireSpawnYield() }, process.Spawn},
		{"Terminate", func() interface{ CmdID() dispatcher.CommandID } { return AcquireTerminateYield() }, process.Terminate},
		{"Cancel", func() interface{ CmdID() dispatcher.CommandID } { return AcquireCancelYield() }, process.Cancel},
		{"Monitor", func() interface{ CmdID() dispatcher.CommandID } { return AcquireMonitorYield() }, process.Monitor},
		{"Unmonitor", func() interface{ CmdID() dispatcher.CommandID } { return AcquireUnmonitorYield() }, process.Unmonitor},
		{"Link", func() interface{ CmdID() dispatcher.CommandID } { return AcquireLinkYield() }, process.Link},
		{"Unlink", func() interface{ CmdID() dispatcher.CommandID } { return AcquireUnlinkYield() }, process.Unlink},
	}
