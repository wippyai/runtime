...
func registerTime(l *lua.LState, mod *lua.LTable) {
	...
	mod.RawSetString("StampMilli", lua.LString(time.StampMilli))
	mod.RawSetString("StampMicro", lua.LString(time.StampMicro))
	mod.RawSetString("StampNano", lua.LString(time.StampNano))
	mod.RawSetString("DateTime", lua.LString("2006-01-02 15:04:05"))
	mod.RawSetString("DateOnly", lua.LString("2006-01-02"))
	mod.RawSetString("TimeOnly", lua.LString("15:04:05"))
