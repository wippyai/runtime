...
func TestManager_AutoSelectPool(t *testing.T) {
	tests := []struct {
		...
		{"lazy when workers=0 size=0", api.PoolConfig{Workers: 0, Size: 0}, "lazy"},
		{"lazy when workers=0 maxsize>0", api.PoolConfig{Workers: 0, MaxSize: 10}, "lazy"},
		{"static when workers>0", api.PoolConfig{Workers: 4}, "static"},
		{"inline when size>0 workers=0", api.PoolConfig{Size: 4, Workers: 0, MaxSize: 0}, "inline"},
	}
