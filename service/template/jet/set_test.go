...
func createTestSet(t *testing.T) *Set {
...
// Helper to create test template set with default delimiters
func createTestSetDefault(t *testing.T) *Set {
	cfg := &template.SetConfig{
		Engine: template.EngineConfig{
			DevelopmentMode: true,
			Delimiters: template.DelimiterConfig{
...
func TestSet_AddTemplate(t *testing.T) {
	// Create a template set
	set := createTestSet(t)
...
func TestSet_UpdateTemplate(t *testing.T) {
	...
	assert.Equal(t, template.ErrTemplateNotFound, err)
}

func TestSet_RemoveTemplate(t *testing.T) {
	// Create a template set with a template
	set := createTestSet(t)
	tmplName := "test-template"
	err := set.AddTemplate(tmplName, "Hello, << name >>!")
...
func TestSet_GetTemplateSource(t *testing.T) {
	// Create a template set with a template
	set := createTestSet(t)
	tmplName := "test-template"
	tmplSource := "Hello, << name >>!"
...
func TestSet_RenderTemplate(t *testing.T) {
	// Create a template set with a template
	set := createTestSet(t)
	tmplName := "test-template"
...
func TestSet_RenderPayload(t *testing.T) {
	// Create a template set with a template
	set := createTestSet(t)
	tmplName := "test-template"
...
func TestSet_Acquire(t *testing.T) {
	// Create a template set with a template
	set := createTestSet(t)
	tmplName := "test-template"
	err := set.AddTemplate(tmplName, "Hello, << name >>!")
...
func TestSet_ResourceRelease(t *testing.T) {
	// Create a template set
	set := createTestSet(t)
...
func TestSet_ConcurrentOperations(t *testing.T) {
	...
	for i := 0; i < concurrency; i++ {
		...
		go func(i int) {
			...
			if err != nil && !errors.Is(err, template.ErrTemplateNotFound) {
				errChan <- err
			}
		}(i)
	}
...
func TestSet_TemplateCacheInvalidation(t *testing.T) {
	set := createTestSet(t)
...
func TestSet_RenderWithInvalidTemplate(t *testing.T) {
	set := createTestSet(t)
...
func TestSet_RenderWithUndefinedVariables(t *testing.T) {
	set := createTestSet(t)
...
func TestSet_RenderWithComplexNestedData(t *testing.T) {
	set := createTestSet(t)
...
func TestCommentHandling(t *testing.T) {
	...
	*}
	...
	// Jet preserves whitespace on lines with comments
	assert.Contains(t, result, "Hello,")
	assert.Contains(t, result, "John!")
	assert.Contains(t, result, "Still here.")
