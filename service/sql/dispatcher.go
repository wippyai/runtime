...
func (d *Dispatcher) handleQuery(ctx context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleExecute(ctx context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handlePrepare(ctx context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleBegin(ctx context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleStmtQuery(ctx context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleStmtExecute(ctx context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleStmtClose(_ context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleTxQuery(ctx context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleTxExecute(ctx context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleTxPrepare(ctx context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleTxCommit(_ context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
...
func (d *Dispatcher) handleTxRollback(_ context.Context, cmd dispatcher.Command, tag any, receiver process.ResultReceiver) error {
