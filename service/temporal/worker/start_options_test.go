...
func TestApplyTemporalStartWorkflowOptions_AllMappedFields(t *testing.T) {
	...
	startOptions.Set(optionWorkflowSearchAttributes, map[string]any{"CustomKeywordField": "tenant-a"})
	...
	assert.Equal(t, map[string]any{"CustomKeywordField": "tenant-a"}, opts.SearchAttributes)
