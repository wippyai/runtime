...
func NewLoggerInterceptor(core zapcore.Core) *LoggerInterceptor {
...
func (t *LoggerInterceptor) Enabled(level zapcore.Level) bool {
...
func (t *LoggerInterceptor) With(fields []zapcore.Field) zapcore.Core {
	return &LoggerInterceptor{
...
func (t *LoggerInterceptor) Check(ent zapcore.Entry, ce *zapcore.CheckedEntry) *zapcore.CheckedEntry {
	if t.isTerminal.Load() {
...
func (t *LoggerInterceptor) Write(ent zapcore.Entry, fields []zapcore.Field) error {
	if t.isTerminal.Load() {
...
func (t *LoggerInterceptor) Sync() error {
	return t.core.Sync()
}

// SetTerminalActive sets whether the terminal is currently active
func (t *LoggerInterceptor) SetTerminalActive(active bool) {
