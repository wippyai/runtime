...
var servicesKey = &ctxapi.Key{Name: "system.services"}

// ServiceState represents the runtime state of a system service.
...
// ServiceInfo provides access to information about running system services.
