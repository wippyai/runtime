...
type NodeInfo struct {
	...
	// LastActive provides a timestamp indicating the last time the
...
type Membership interface {
	...
	// UpdateNodeMeta allows the local node to modify its own application-specific
	...
	UpdateNodeMeta(meta []byte) error
}
