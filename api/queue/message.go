...
type Message struct {
	ID      string          // Unique message identifier (driver-specific)
	Body    payload.Payload // Message content
	Headers attrs.Bag       // Message metadata and headers (including timestamp)
}
