...
func init() {
	dispatcher.MustRegisterCommands("workflow", SideEffect, Exec, Version, UpsertAttrs)
}
...
const (
	...
	// Exec is the command ID for synchronous child workflow execution.
	Exec dispatcher.CommandID = 181
...
// ExecCmd requests synchronous child workflow execution.
...
// ExecOptions configures child workflow execution.
...
// ExecResult is the result of a workflow.exec operation.
