...
const (
	...
	ClusterInternodeAdvertiseCandidates boot.Name = "internode.advertise_candidates"
	...
	ClusterMembershipAdvertiseCandidates boot.Name = "membership.advertise_candidates"
