...
func (m *mockComponent) Register(ctx context.Context, event events.Event, chs State) (State, error) {
...
// TestHubListenEvents tests the events listening functionality
func TestUpdateState(t *testing.T) {
	...
	cmp.On("Register",
		...
		mock.MatchedBy(func(event events.Event) bool {
