...
`,
	...
	rootDir, cleanup := temp_files.TempDirWithFiles(t, "folderloader_test", files)
	defer cleanup()
...
func TestFolderLoader_Load_NoFiles(t *testing.T) {
	...
	rootDir, cleanup := temp_files.TempDirWithFiles(t, "folderloader_empty", nil)
	defer cleanup()
...
func TestFolderLoader_Load_InvalidYaml(t *testing.T) {
	...
	rootDir, cleanup := temp_files.TempDirWithFiles(t, "folderloader_invalid_yaml", files)
	defer cleanup()
...
`,
	...
	rootDir, cleanup := temp_files.TempDirWithFiles(t, "folderloader_missing", files)
	defer cleanup()
...
`,
	...
	rootDir, cleanup := temp_files.TempDirWithFiles(t, "folderloader_invalid", files)
	defer cleanup()
