...
local function main()
	...
	local resp, err = http.get("http://localhost:18085/test/echo?test=headers&header=X-Custom-Header", {
	...
	local resp2, err2 = http.get("http://localhost:18085/test/echo?test=custom_headers")
