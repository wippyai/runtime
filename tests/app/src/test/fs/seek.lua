...
local function main()
    ...
    -- Create test file
    local ok, err = vol:writefile(path, "0123456789ABCDEF")
    assert.ok(ok, "create test file")

    -- Open for reading
    local file, err = vol:open(path, "r")
