...
local function main()
	...
	local resp1, err1 = http.get("http://localhost:18085/test/response-headers?test=normal")
	...
	local resp2, err2 = http.get("http://localhost:18085/test/response-headers?test=write_then_status")
	...
	local resp3, err3 = http.get("http://localhost:18085/test/response-headers?test=write_then_header")
	...
	local resp4, err4 = http.get("http://localhost:18085/test/response-headers?test=write_then_content_type")
	...
	local resp5, err5 = http.get("http://localhost:18085/test/response-headers?test=write_then_transfer")
	...
	local resp6, err6 = http.get("http://localhost:18085/test/response-headers?test=sse_auto")
