...
// Source: github.com/wippyai/module-registry-proto/gen/registry/identity/v1/identityv1connect (interfaces: OrganizationServiceClient)
//
// Generated by this command:
//
//	mockgen -destination tests/mock/identityv1connect/identityv1connect.go github.com/wippyai/module-registry-proto/gen/registry/identity/v1/identityv1connect OrganizationServiceClient
//
...
func (m *MockOrganizationServiceClient) ListUserOrganizations(arg0 context.Context, arg1 *connect.Request[identityv1.ListUserOrganizationsRequest]) (*connect.Response[identityv1.ListUserOrganizationsResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListUserOrganizations", arg0, arg1)
	ret0, _ := ret[0].(*connect.Response[identityv1.ListUserOrganizationsResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
