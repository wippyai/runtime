...
local function define_tests()
    ...
    describe("Actor Library Tests", function()
        ...
        describe("Async Function Execution", function()
            ...
            it("should send messages to internal channel with source information", function()
                ...
                -- Create a mock internal channel that records sent messages
                local internal_channel = {
                ...
                -- Mock coroutine to execute function immediately
                _G.coroutine = {
                    spawn = function(fn)
                ...
                -- Verify message was sent with source info
                expect(sent_message).not_to_be_nil("Message should be sent to internal channel")
                expect(sent_message.type).to_equal("test_message", "Message should have correct type")
                expect(sent_message.payload.value).to_equal(42, "Message should have correct payload")
                expect(sent_message.from).to_equal("test_source", "Message should include source information")
            end)
        end)
