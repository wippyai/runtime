...
- ✓ Fresh-context security review approved `55bc0336..5bd49e4d`; no concrete finding reached confidence 8/10.
...
- ✓ Statement coverage rose from 61.4% to 62.9%; changed-statement coverage is 82.6%.
...
- The exact final Linux JSON report attests code head `5bd49e4d`; later changes only update specifications and review records.
