...
- Differential coverage of changed production statements: 82.4%.
- Gate v3 reconciles the +200 inventory delta, the one accepted pre-existing SQS Docker skip exposed by short-mode `m.Run`, and the closed review-fix allowlist.
