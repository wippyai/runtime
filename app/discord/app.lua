...
function App()
    ...
    app.command_handler = CommandHandler.new(app.client, app.ui)
                ...
                elseif self.keys.submit:matches(msg) then
                    ...
                    if value ~= "" then
                        if value:match("^!") then
                            ...
                            local active_channel = self.client:get_active_channel()
                            if active_channel then
                                self.client:send_message(active_channel.id, value)
